...
const SLIDES = [
  ...
  { id: 's5',  label: 'Users' },
  { id: 's6',  label: 'Competitors' }, 
  { id: 's7',  label: 'Journey' },
  { id: 's8',  label: 'Platform' },
  { id: 's9',  label: 'Architecture' },
  { id: 's10', label: 'Interop' },
  { id: 's11', label: 'Testing' },
  { id: 's12', label: 'Demo' },
  { id: 's13', label: 'Challenges' },
  { id: 's14', label: 'Reflection' },
  { id: 's15', label: 'Final Pitch' },
];
